// Used a js library here to create the interactive hero background carosel. Credit goes to https://github.com/hmongouachon/rgbKineticSlider

const images = ["./imgs/img-1.png", "./imgs/img-2.png", "./imgs/img-3.png"];
const texts = [
  ["INTERACTIVE CONCERT EXPERIENCE", "Expreiance your favourite artists like never before and from the comfort of your own home"],
  ["INTERACTIVE CONCERT EXPERIENCE", "Expreiance your favourite artists like never before and from the comfort of your own home"],
  ["INTERACTIVE CONCERT EXPERIENCE", "Expreiance your favourite artists like never before and from the comfort of your own home"],
];
